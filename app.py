...
SERVICE_ACCOUNT_FILE = os.getenv("GOOGLE_APPLICATION_CREDENTIALS")  # expects the env var to be set on Render
SHEET_ID = "1L2ih057w37xAkgL2bkP600iYpDyj215R6ZDjXniLIao"

creds = Credentials.from_service_account_file(SERVICE_ACCOUNT_FILE, scopes=SCOPES)
client = gspread.authorize(creds)
sheet = client.open_by_key(SHEET_ID).sheet1  # or worksheet("Sheet1") if renamed
